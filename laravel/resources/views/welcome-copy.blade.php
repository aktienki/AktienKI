    ...
    <main>
        ...
        <section class="border-y border-cyan-300/10 bg-[#071523]/78">
            <div class="mx-auto grid max-w-[1540px] gap-px px-5 sm:grid-cols-2 sm:px-8 lg:grid-cols-4 xl:px-10">
                @foreach ([[__('Datenbasis'),__('Kurse, Fundamentals und Makrodaten'),'database'],[__('Modellprüfung'),__('Walk-Forward, Filter und Stabilität'),'chart'],[__('Klare Signale'),__('POSITIV, WAIT und risikobasiertes HOLD'),'signal'],[__('Strategien'),__('Backtests mit dynamischen Exits'),'strategy']] as $i=>[$title,$text,$icon])
