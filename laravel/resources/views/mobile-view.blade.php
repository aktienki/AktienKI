<x-app-layout>
    @php
        $labels = [
            ...
            'market-summary' => __('Kompakter Marktbericht'), 'schedule' => __('Termine & Erinnerungen'),
            'mobile-view' => __('Mobile Ansicht konfigurieren'),
        ];
        $descriptions = [
            'strategy' => __('Depotwert und Performance.'), 'personal' => __('Deine wichtigsten Schnellzugriffe.'),
            ...
            'signal-cockpit' => __('Signalwechsel und ChartView-Signale.'), 'models' => __('Aktuelle Modellläufe nach Region.'),
            'signals' => __('Neue Empfehlungen und Übergänge.'), 'earnings' => __('Die letzten Quartalsergebnisse.'),
            'market-summary' => __('Die Marktlage in Kurzform.'), 'schedule' => __('Bevorstehende Termine und E-Mails.'),
