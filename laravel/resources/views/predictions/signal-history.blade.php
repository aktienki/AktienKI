<x-app-layout>
    ...
    <div class="mx-auto max-w-[1800px] px-4 py-8 sm:px-6 lg:px-8">
        ...
        @php
            ...
            $chartCards = [
                ['key' => 'performance', 'title' => 'Performanceverlauf', 'subtitle' => 'Kumulierte Trade-Performance'.($demo ? ' · Simulation' : ''), 'color' => '#14b8a6', 'suffix' => ' %'],
