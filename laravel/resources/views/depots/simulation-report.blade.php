...
.depot-card,.chart-card{height:150px;border:1px solid #1b8394;background:#0d2235;color:#e7f0f7;border-radius:8px;box-shadow:0 0 0 1px rgba(45,212,191,.08) inset}
...
.report-header{padding:12px 16px;border:1px solid rgba(45,212,191,.48);border-radius:9px;background:linear-gradient(135deg,#0d2235 0%,#101d32 60%,#102b3b 100%);box-shadow:0 0 0 1px rgba(34,211,238,.08) inset}
