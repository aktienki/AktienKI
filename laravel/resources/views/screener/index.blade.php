<x-app-layout>
    ...
    <style>
        ...
        @media (max-width:767px) {
            ...
            .screener-page .sms-v2-forecast>i.is-trigger-horizon{border-bottom:2px solid color-mix(in srgb,#22d3ee 72%,transparent)!important}
