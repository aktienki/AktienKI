<x-app-layout>
    ...
    <style>
        @media (min-width:768px) {
            ...
            .screener-page .screener-desktop-forecasts>i.is-trigger-horizon{border-color:color-mix(in srgb,#22d3ee 48%,transparent)!important;background:color-mix(in srgb,#22d3ee 11%,transparent)!important;box-shadow:inset 0 -2px 0 color-mix(in srgb,#22d3ee 72%,transparent)!important}
