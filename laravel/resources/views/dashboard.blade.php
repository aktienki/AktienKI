            ...
            <section class="grid gap-3 sm:grid-cols-2 xl:min-h-0 xl:flex-1 xl:grid-cols-6">
                @if ($strategyPortfolio)
                    ...
                    <article class="ak-card ak-dashboard-card mt-3 overflow-hidden p-4">
                        ...
                        <div class="grid grid-cols-2 overflow-hidden rounded-xl border border-orange-400/15 sm:grid-cols-4">
                            @foreach ([
                                ...
                                <a href="{{ $url }}" class="group min-w-0 border-orange-400/15 bg-orange-400/[.035] px-3 py-3 transition hover:bg-orange-400/[.10] [&:not(:last-child)]:border-r">
                        ...
                        @foreach ($continentPredictions as $continent)
                            <div class="grid grid-cols-[28px_minmax(0,1fr)_auto] items-center gap-2 rounded-lg border border-orange-400/15 bg-orange-400/[.04] px-2.5 py-2">
                                ...
                                <span class="flex items-center gap-1 text-[10px] font-black tabular-nums">
                                    <i class="rounded bg-orange-400/18 px-1.5 py-1 not-italic text-orange-200">B {{ $continent['buy'] }}</i>
                ...
                <article class="ak-card ak-dashboard-card overflow-hidden border-orange-400/35 p-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <a href="{{ route('predictions.index', ['signal' => 'WATCH']) }}" class="ak-watch-surface rounded-lg border border-amber-300/20 bg-amber-400/[.05] p-2.5 transition hover:bg-amber-400/[.10]">
                    ...
                    <a href="{{ route('signal-changes.index', ['days' => 2]) }}" class="mt-2.5 block rounded-lg border border-orange-400/15 bg-orange-400/[.035] p-2.5 transition hover:bg-orange-400/[.08]">
                        <div class="flex items-center justify-between gap-3">
