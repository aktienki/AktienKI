...
<section class="hero">
    <div class="container hero-grid">
        <section class="copy">
            ...
            <h1 class="title text-lg">Die nächste<br>Generation der <span>Aktienanalyse.</span></h1>
        ...
        <section id="heroDemo" class="visual">
            ...
            <div class="terminal">
                <div class="terminal-top"><div class="terminal-title"><span>▥</span><strong id="sceneLabel">MACHINE LEARNING PIPELINE</strong></div><div class="scene-switch"><span id="sceneCounter">SZENE 1 / 5</span><div class="dots" data-dots></div></div></div>
                <div class="terminal-body">
                    ...
                    <div class="scene scene-market" data-scene="2">
                        <div class="panel">
