<style>
    ...
    .ak-detail-design .ak-detail-card-head {
        border-bottom-color: rgba(8, 145, 178, .28) !important;
        background:
            radial-gradient(circle at 5% 0%, rgba(34, 211, 238, .19), transparent 40%),
            linear-gradient(108deg, rgba(8, 145, 178, .20), rgba(6, 182, 212, .11) 44%, rgba(6, 182, 212, .06) 75%, transparent) !important;
        box-shadow: 0 6px 16px rgba(14, 116, 144, .055);
    }

    .ak-detail-design :is(.text-violet-200, .text-violet-300) { color: #22d3ee !important; }
    ...
    :root[data-theme="light"] .ak-detail-design .ak-detail-card-head :is(.text-teal-200, .text-teal-300) { color: #0e7490 !important; }

    .ak-detail-design .ak-standard-card-head {
        position: relative;
        margin: -1rem -1rem .8rem;
        padding: .9rem 1rem .8rem;
        border-bottom: 1px solid rgba(8, 145, 178, .24);
        background:
            radial-gradient(circle at 6% 0%, rgba(34, 211, 238, .18), transparent 38%),
            linear-gradient(108deg, rgba(8, 145, 178, .18), rgba(6, 182, 212, .10) 46%, transparent 82%);
    }

    :root:not([data-theme="light"]) body:not(.welcome-background) .ak-detail-design .ak-standard-card {
        border-color: color-mix(in srgb, var(--ak-border) 72%, #06b6d4 28%) !important;
        background:
    ...
    .ak-detail-design .ak-standard-card :is(.text-orange-400, .text-orange-300) { color: #06b6d4 !important; }
</style>
