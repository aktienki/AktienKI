<div class="product-scene" aria-label="Animierte Originalansicht aus dem AktienKI Dashboard">
    ...
    <article class="product-card product-cockpit-card">
        <div class="product-cockpit-head">
            ...
            <span><small>PRO · 5 HANDELSTAGE</small><strong>Signal-Cockpit</strong><em><b>3 POSITIV</b> <i>1 SELL</i> Ø KI 7,4 · Ø Risiko 8%</em></span>
        ...
        <div class="product-signal-table">
            ...
            @foreach([
                ['🇺🇸','KLA Corporation','WATCH → POSITIV','22.08.','+2,8%','+4,6%','+6,2%','+9,1%'],
                ['🇩🇪','SAP SE','HOLD → POSITIV','21.08.','+1,4%','+3,9%','+5,1%','+7,6%'],
                ['🇳🇱','ASML Holding N.V.','WATCH → POSITIV','20.08.','−0,4%','+2,2%','+4,8%','+8,7%'],
            ] as $row)
