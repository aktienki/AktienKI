...
<div style="color:#ffffff;font-size:31px;font-weight:900;margin-top:8px">{{ number_format((float)($assessment['score'] ?? 50), 0, ',', '.') }}<span style="font-size:12px;color:#8fa4ba"> /100</span></div>
...
<tr><td style="color:#91a6ba;border-top:1px solid #263d52">{{ __('KI-Score') }}</td><td align="right" style="font-weight:700;border-top:1px solid #263d52">{{ number_format($topStock['score'], 0, ',', '.') }} /100</td></tr>
...
<tr><td style="border-top:1px solid #3d3b30;font-weight:800">{{ $stock['symbol'] }}</td><td style="border-top:1px solid #3d3b30;color:#9eb1c3">{{ signal_label($stock['signal']) }}</td><td align="right" style="border-top:1px solid #3d3b30;color:#d9a84e;font-weight:800">{{ $stock['score'] !== null ? number_format($stock['score'], 0, ',', '.').' /100' : '–' }}</td></tr>
@endforeach
</table>
</div>
