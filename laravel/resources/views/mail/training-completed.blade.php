...
<div style="font-size:19px;font-weight:900;color:#ffffff;margin:0 0 5px">Standard und reines TCN</div>
<div style="color:#9fb5c5;font-size:11px;line-height:1.45;margin-bottom:12px">{{ $holdingPolicy ?? 'Eine Position je Aktie bleibt bis zum Verkaufstag des gewählten Horizonts geöffnet.' }}</div>
...
<tbody>
<tr>
<td data-label="Modell" style="font-weight:800;color:#ffffff">Standard</td>
...
<tr>
<td data-label="Modell" style="font-weight:800;color:#ffffff">Reines TCN</td>
...
@empty
<div style="border-top:1px solid #284055;color:#ffffff;padding-top:10px">Noch keine Walk-Forward-Auswertung vorhanden.</div>
@endforelse
</div>
