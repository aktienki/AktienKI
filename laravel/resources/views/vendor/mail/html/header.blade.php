@props(['url'])
<table data-aktienki-mail-header="standard" role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;background:#0b192b;border-bottom:1px solid #29475e">
    <tr>
                ...
                <tr>
                    <td valign="middle" style="width:52%">
                        <a href="{{ $url }}" style="display:inline-block;text-decoration:none">
                            <img src="cid:aktienki-logo.png" width="230" alt="aktienKI.com" style="display:block;width:230px;max-width:100%;height:auto;border:0">
                        </a>
                    </td>
