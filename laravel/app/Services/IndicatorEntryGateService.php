...
class IndicatorEntryGateService
{
    ...
    public function assessLegacyPrediction(int $predictionId): array
    {
        ...
        if ($legacy === null) return ['passed'=>false, 'reason_codes'=>['INDICATOR_LEGACY_SOURCE_MISSING']];
        ...
        if ($scope === null) return ['passed'=>true,'applied'=>false,'reason_codes'=>[]];
        ...
        if (! is_int($id) || $id <= 0) return ['passed'=>false,'applied'=>true,'reason_codes'=>['INDICATOR_LEGACY_SOURCE_UNBOUND']];
