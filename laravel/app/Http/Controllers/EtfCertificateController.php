...
class EtfCertificateController extends Controller
{
    public function __invoke(Request $request, TechnicalPriceLevelService $priceLevels): View
    {
        ...
        return view('securities.index', compact('tab', 'search', 'type', 'underlyingId', 'discountMin', 'returnMin', 'returnPaMin', 'maturityFrom', 'maturityTo', 'sort', 'direction', 'etfs', 'certificates', 'officialCertificates', 'officialCatalogDate', 'stats'));
    }
