...
PROJECT = Path('/home/akiadmin/projects/ml/AktienKI-Python-Engine')
...
REGISTRY = PROJECT / 'models_storage/registry'
PHASE_FILTER_DIR = PROJECT / 'models_storage/phase_filters'
SSH_KEY = '/home/akiadmin/.ssh/aktienki_model_upload_workstation'
SSH = ['ssh', '-i', SSH_KEY, 'root@217.154.240.14']
RSYNC_SSH = f'ssh -i {SSH_KEY}'
HORIZONS = (5, 10, 15, 20)
LOG = PROJECT / 'logs/workstation-dax-full-pipeline.log'
BLOCKS_BASE = PROJECT / 'logs/workstation-dax-full-blocks'
